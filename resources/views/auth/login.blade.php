    ...
    <x-slot:content>
        <div class="flex">
            <form action="" method="POST" class="px-6 mt-12 text-shadow-sm flex flex-col w-[30%]">
                <legend class="text-white font-inter font-semibold tracking-wide text-shadow-lg text-6xl flex-1">Login</legend>
                ...
                <button class="mx-auto my-32 bg-white hover:bg-gray-100 text-3xl text-gray-800 font-semibold py-3 px-5 border border-gray-400 rounded shadow cursor-pointer font-inter">
                    Entrar
                </button>
            </form>
            <div class="background-primary-color w-[70%] h-screen m-0 p-0 ml-auto text-center h-screen">
                <h1 class="text-white font-bold text-8xl font-inter m-0 mt-32 tracking-wider text-shadow-lg">Ponto Prati</h1>
